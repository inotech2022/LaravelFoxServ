    ...
    <input type="submit" name="submit" class="btn-login" id="submit" value="Editar">
            ...
            <h1>Editar Contrato</h1>
                ...
                <div class="linha">
                    ...
                    <input type="date" name="dataFinal" id="data_serv_fim" value="{{ old('dataFinal', $contract->endDate ? $contract->endDate->format('Y-m-d') : '') }}"
 required>
                    </div>
                ...
                <div class="linha">
                    <div class="input-box">
                        ...
                        <textarea name="descricao" placeholder="Descrição dos serviços, habilidades, idiomas..." required maxlength="100">{{ $contract->description ?? '' }}</textarea>
